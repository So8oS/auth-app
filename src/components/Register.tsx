  ...
  return (
    <div className='flex flex-col'>
      ...
      <form className='flex flex-col gap-4 mt-6'>
          ...
          <button className='bg-[#2F80ED] w-full h-9 text-white text rounded-lg'>Start coding now</button>
      </form>
      ...
      <div className="flex flex-col justify-center items-center mt-5 gap-4">
        <p className='font-normal text-[#828282]'>or continue with these social profile</p>
          <div className='flex gap-5'>
              <div className=" flex justify-center items-center p-2  rounded-full border border-[#828282]">
                <AiOutlineGoogle className='text-[#828282]' />
              </div>
              <div className=" flex justify-center items-center p-2  rounded-full border border-[#828282]">
                <FaFacebookSquare className='text-[#828282]' />
              </div>
              <div className=" flex justify-center items-center p-2  rounded-full border border-[#828282]">
                <AiOutlineTwitter className='text-[#828282]' />
              </div>
              <div className=" flex justify-center items-center p-2  rounded-full border border-[#828282]">
